...
pub trait DynamoDb<D: DispatchSignedRequest> {
    ...
    fn batch_get_item
        (&self,
         ...
         -> Box<Future<Item = BatchGetItemOutput, Error = BatchGetItemError> + 'static>;
    ...
    fn batch_write_item
        (&self,
         ...
         -> Box<Future<Item = BatchWriteItemOutput, Error = BatchWriteItemError> + 'static>;
    ...
    fn create_table
        (&self,
         ...
         -> Box<Future<Item = CreateTableOutput, Error = CreateTableError> + 'static>;
    ...
    fn delete_item(&self,
                   ...
                   -> Box<Future<Item = DeleteItemOutput, Error = DeleteItemError> + 'static>;
    ...
    fn delete_table
        (&self,
         ...
         -> Box<Future<Item = DeleteTableOutput, Error = DeleteTableError> + 'static>;
    ...
    fn describe_limits
        (&self)
         -> Box<Future<Item = DescribeLimitsOutput, Error = DescribeLimitsError> + 'static>;
    ...
    fn describe_table
        (&self,
         ...
         -> Box<Future<Item = DescribeTableOutput, Error = DescribeTableError> + 'static>;
    ...
    fn describe_time_to_live
        (&self,
         ...
         -> Box<Future<Item = DescribeTimeToLiveOutput, Error = DescribeTimeToLiveError> + 'static>;
    ...
    fn get_item(&self,
                input: &GetItemInput)
                -> Box<Future<Item = GetItemOutput, Error = GetItemError> + 'static>;
    ...
    fn list_tables(&self,
                   ...
                   -> Box<Future<Item = ListTablesOutput, Error = ListTablesError> + 'static>;
    ...
    fn list_tags_of_resource
        (&self,
         ...
         -> Box<Future<Item = ListTagsOfResourceOutput, Error = ListTagsOfResourceError> + 'static>;
    ...
    fn put_item(&self,
                input: &PutItemInput)
                -> Box<Future<Item = PutItemOutput, Error = PutItemError> + 'static>;
    ...
    fn query(&self,
             input: &QueryInput)
             -> Box<Future<Item = QueryOutput, Error = QueryError> + 'static>;
    ...
    fn scan(&self,
            input: &ScanInput)
            -> Box<Future<Item = ScanOutput, Error = ScanError> + 'static>;
    ...
    fn tag_resource(&self,
                    ...
                    -> Box<Future<Item = (), Error = TagResourceError> + 'static>;
    ...
    fn untag_resource(&self,
                      ...
                      -> Box<Future<Item = (), Error = UntagResourceError> + 'static>;
    ...
    fn update_item(&self,
                   ...
                   -> Box<Future<Item = UpdateItemOutput, Error = UpdateItemError> + 'static>;
    ...
    fn update_table
        (&self,
         ...
         -> Box<Future<Item = UpdateTableOutput, Error = UpdateTableError> + 'static>;
    ...
    fn update_time_to_live
        (&self,
         ...
         -> Box<Future<Item = UpdateTimeToLiveOutput, Error = UpdateTimeToLiveError> + 'static>;
}
...
impl<P, D> DynamoDb<D> for DynamoDbClient<P, D>
    where P: ProvideAwsCredentials,
          D: DispatchSignedRequest,
          D::Chunk: 'static
{
    ...
    fn describe_time_to_live
        ...
        Box::new({
            self.dispatcher.dispatch(request).map_err(|err| err.into()).and_then(|response| {
