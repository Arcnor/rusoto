...
pub trait DynamoDb<D: DispatchSignedRequest> {
    ...
    fn batch_get_item(&self,
                      ...
                      -> Box<Future<Item = BatchGetItemOutput, Error = BatchGetItemError>>;
    ...
    fn batch_write_item
        (&self,
         ...
         -> Box<Future<Item = BatchWriteItemOutput, Error = BatchWriteItemError>>;
    ...
    fn create_table(&self,
                    ...
                    -> Box<Future<Item = CreateTableOutput, Error = CreateTableError>>;
    ...
    fn delete_item(&self,
                   ...
                   -> Box<Future<Item = DeleteItemOutput, Error = DeleteItemError>>;
    ...
    fn delete_table(&self,
                    ...
                    -> Box<Future<Item = DeleteTableOutput, Error = DeleteTableError>>;
    ...
    fn describe_limits(&self)
                       -> Box<Future<Item = DescribeLimitsOutput, Error = DescribeLimitsError>>;
    ...
    fn describe_table(&self,
                      ...
                      -> Box<Future<Item = DescribeTableOutput, Error = DescribeTableError>>;
    ...
    fn describe_time_to_live
        (&self,
         ...
         -> Box<Future<Item = DescribeTimeToLiveOutput, Error = DescribeTimeToLiveError>>;
    ...
    fn get_item(&self,
                input: &GetItemInput)
                -> Box<Future<Item = GetItemOutput, Error = GetItemError>>;
    ...
    fn list_tables(&self,
                   ...
                   -> Box<Future<Item = ListTablesOutput, Error = ListTablesError>>;
    ...
    fn list_tags_of_resource
        (&self,
         ...
         -> Box<Future<Item = ListTagsOfResourceOutput, Error = ListTagsOfResourceError>>;
    ...
    fn put_item(&self,
                input: &PutItemInput)
                -> Box<Future<Item = PutItemOutput, Error = PutItemError>>;
    ...
    fn tag_resource(&self,
                    ...
                    -> Box<Future<Item = (), Error = TagResourceError>>;
    ...
    fn untag_resource(&self,
                      ...
                      -> Box<Future<Item = (), Error = UntagResourceError>>;
    ...
    fn update_item(&self,
                   ...
                   -> Box<Future<Item = UpdateItemOutput, Error = UpdateItemError>>;
    ...
    fn update_table(&self,
                    ...
                    -> Box<Future<Item = UpdateTableOutput, Error = UpdateTableError>>;
    ...
    fn update_time_to_live
        (&self,
         ...
         -> Box<Future<Item = UpdateTimeToLiveOutput, Error = UpdateTimeToLiveError>>;
}
